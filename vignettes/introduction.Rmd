...
-   **`events`**: A named list recording every demographic event that
    ...
    event occurred), `types` (0=death, 1=birth, 2=dispersal,
    ...
    `phenotypes` and `widths` (genotype_sd). This complete history
...
`genotype_sd = 0`, reproduction requires an exact phenotype-environment
...
genotype_mean = 1.0 coincides exactly with any cell's environmental
